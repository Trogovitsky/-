(function ($) {
	...
	document.addEventListener('DOMContentLoaded', function() {
		function updateWeather() {
			fetch('weather_data.json?' + new Date().getTime())
				...
				.then(data => {
					...
					weatherDiv.innerHTML = `
						<div class="weather-main">
							...
							<p class="feels-like">Ощущается как ${data.feels_like}°C</p>
						</div>
					...
					lastUpdate.textContent = `Последнее обновление: ${timeString}`;
					dataSources.textContent = `Источники данных: ${data.sources.join(', ')}`;
				})
				.catch(error => {
